...
import com.example.audiocutterdemo2.core.amplituda.exceptions.io.FileNotFoundException;
import com.example.audiocutterdemo2.core.amplituda.exceptions.io.InvalidAudioByteArrayException;
import com.example.audiocutterdemo2.core.amplituda.exceptions.io.InvalidAudioInputStreamException;
import com.example.audiocutterdemo2.core.amplituda.exceptions.io.InvalidAudioUrlException;
import com.example.audiocutterdemo2.core.amplituda.exceptions.io.InvalidRawResourceException;
...
public final class Amplituda {
    ...
    public AmplitudaProcessingOutput<String> processAudio(
        ...
        return processAudio(audio, Compress.getDefault(), Cache.getDefault(), listener, null);
    }
    ...
    public AmplitudaProcessingOutput<InputStream> processAudio(
        ...
        return processAudio(audio, Compress.getDefault(), Cache.getDefault(), uri, listener);
    }
    ...
    public AmplitudaProcessingOutput<File> processAudio(
        ...
        return processAudio(audio, compressParams, Cache.getDefault(), listener, null);
    }
    ...
    public AmplitudaProcessingOutput<InputStream> processAudio(
        ...
        return processAudio(audio, compressParams, Cache.getDefault(), uri, listener);
    }
    ...
    public AmplitudaProcessingOutput<File> processAudio(
        ...
        return processAudio(audio, Compress.getDefault(), cacheParams, listener, null);
    }
    ...
    public AmplitudaProcessingOutput<InputStream> processAudio(
        ...
        return processAudio(audio, Compress.getDefault(), cacheParams, null, listener);
    }
    ...
    public AmplitudaProcessingOutput<File> processAudio(
        ...
        try {
            return new AmplitudaProcessingOutput<>(
                    processFileJNI(audio, inputAudio, compress, cache, listener, uri),
                    inputAudio
            );
    ...
    public AmplitudaProcessingOutput<String> processAudio(
        ...
        try {
            ...
            if (!URLUtil.isValidUrl(audio)) {
                ...
                return new AmplitudaProcessingOutput<>(
                        processFileJNI(new File(audio), inputAudio, compress, cache, listener, uri),
                        inputAudio
                );
            }
            // When audio is URL
            ...
            AmplitudaResultJNI result =
                    processFileJNI(tempAudio, inputAudio, compress, cache, listener, uri);
    ...
    public AmplitudaProcessingOutput<Integer> processAudio(
        ...
        try {
            ...
            AmplitudaResultJNI result = processFileJNI(tempAudio, inputAudio, compress, cache, listener, uri);
            // Delete tmp
            fileManager.deleteFile(tempAudio);
            return new AmplitudaProcessingOutput<>(result, inputAudio);
        } catch (AmplitudaException exception) {
    ...
    private synchronized <T> AmplitudaResultJNI processFileJNI(
        ...
        if (result == null) {
            ...
            result = amplitudesFromAudioJNI(
                    ...
                    cacheFile.exists() ? cacheFile.getPath() : "",
                    cache.isEnabled(),
                    listener,
                    uri
            );
    ...
    native void setActive(boolean active);
